//
// NOTE: This file was derived from code of "Statiq.Framework", licensed under the MIT License
// For details, see the LICENSE file in the repository root.
//
// The original version of the file can be found here
// https://github.com/statiqdev/Statiq.Framework/blob/65ac4aad24950622be8cefaaff2e9e001d51d2ef/src/core/Statiq.Common/IO/Globbing/Globber.cs
//
    ...
    internal static class Globber
    {
        ...
        internal static IEnumerable<string> ExpandBraces(string pattern)
        {
            ...
            if (numset.Success)
            {
                ...
                int start = Int32.Parse(numset.Groups[1].Value),
                end = Int32.Parse(numset.Groups[2].Value),
                inc = start > end ? -1 : 1;
